import { append, BaseHTMLElement, first, html as htmlFrag, onEvent, trigger } from 'dom-native';
...
export class BaseDialog extends BaseHTMLElement {
	...
	//// Key Elements
	get dialogEl():HTMLElement { return first(this, '.dialog') as HTMLElement };
	get headerEl():HTMLElement { return first(this, '.dialog > header')! as HTMLElement };
	get contentEl():HTMLElement { return first(this, '.dialog > section.dialog-content')! as HTMLElement };
	get footerEl():HTMLElement { return first(this, '.dialog > footer') as HTMLElement };
