export type Op = '$eq'
	| '$in' | '$not' | '$notIn' | '$contains' | '$containsAny' | '$containsAll' | '$notContains' | '$notContainsAny' | '$startsWith' | '$startsWithAny' | '$notStartsWith' | '$notStartsWithAny' | '$endsWith' | '$endsWithAny' | '$notEndsWith' | '$notEndsWithAny' | '$lt' | '$lte' | '$gt' | '$gte' | '$null'
